<#
.SYNOPSIS
Get-VPGRPO.ps1 retrieves information from the Zerto API hosted and maintained by My2Cloud. The intention of this script is to output all VPGs as individual channels and their current RPO to the PRTG Monitoring Platform.
 
.DESCRIPTION
Get-VPGRPO.ps1 is intended for use within the PRTG monitoring platform. Instructions for how the script should be configured are contained within my blog post.
